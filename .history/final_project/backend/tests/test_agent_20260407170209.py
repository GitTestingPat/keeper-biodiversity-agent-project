...
class TestBiodiversityTools:
    ...
    async def test_analyze_deforestation_mock(self):
        ...
        with patch(
            'tools.biodiversity_tools.satellite_service'
        ) as mock_satellite:
    ...
    async def test_detect_illegal_fishing_protected_area(self):
        ...
        with patch('tools.biodiversity_tools.ocean_service') as mock_ocean:
            ...
            with patch(
                'tools.biodiversity_tools.alert_service'
            ) as mock_alerts:
                ...
                assert result["success"] is True
                # Verificar que se creó alerta para área protegida
                # con riesgo alto
...
class TestAlertService:
    ...
    def test_create_alert_structure(self):
        ...
        from services.alert_service 
                import alert_service, AlertType, AlertSeverity
