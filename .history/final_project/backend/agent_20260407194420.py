...
def create_agent():
    ...
    prompt = ChatPromptTemplate.from_messages([
        (
            "system", "Eres un experto en biodiversidad. Usa las herramientas "
            "para obtener datos reales. Responde en español."
        ),
        ("human", "{input}"),
    ...
    # Crear el EJECUTOR
    # (esto maneja el bucle de tool_calls -> tool_output -> final answer)
    agent_executor = AgentExecutor(
        agent=agent,
        tools=tools,
        verbose=True,  # Ver los pasos en la consola
